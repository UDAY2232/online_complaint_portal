...
-- ================= LEGACY: USER_ROLES (if needed for backwards compat) =================
...
-- Legacy user_roles entries
INSERT INTO user_roles (email, role) VALUES 
('complaintportals@gmail.com', 'admin');

-- ================= ALTER STATEMENTS (For existing databases) =================
-- Run these if you already have the complaints table:
